...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002234908446 -1002480305689').split()]  # For Multiple Id Use One Space Between Each.
